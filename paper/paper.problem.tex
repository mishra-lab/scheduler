At St.\ Michael's Hospital, the division of infectious diseases offers
...
%     helpful to do so. Maybe double check with SM though.  SM: agree with JK and it reads nicely to see the definition of constraints up front here.
...
\begin{table}[h]
  ...
  %     \usepackage{caption}\captionsetup[table]{skip=1em}		SM: I need to learn these tricks for appendices of modeling papers!
