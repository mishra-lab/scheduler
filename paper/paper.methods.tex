...
\end{align}
where $\varphi(b)$ maps a block one-to-one to an adjacent weekend, by whichever definition of adjacency being considered. For instance, in the above example we will have $\varphi(b) = 2b - 1$. \\
