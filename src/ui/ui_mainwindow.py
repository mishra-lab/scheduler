...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.settingsGroupBox)
        ...
        self.loadConfigButton = QtWidgets.QPushButton(self.settingsGroupBox)
        self.loadConfigButton.setObjectName("loadConfigButton")
        self.settingsForm.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.loadConfigButton)
        self.requestsHolidaysLabel = QtWidgets.QLabel(self.settingsGroupBox)
        self.requestsHolidaysLabel.setObjectName("requestsHolidaysLabel")
        self.settingsForm.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.requestsHolidaysLabel)
        self.loadRequestsHolidaysButton = QtWidgets.QPushButton(self.settingsGroupBox)
        self.loadRequestsHolidaysButton.setObjectName("loadRequestsHolidaysButton")
        self.settingsForm.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.loadRequestsHolidaysButton)
        self.calendarYearLabel = QtWidgets.QLabel(self.settingsGroupBox)
        self.calendarYearLabel.setObjectName("calendarYearLabel")
        self.settingsForm.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.calendarYearLabel)
        ...
        self.settingsForm.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.calendarYearSpinBox)
        ...
        self.settingsForm.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.numberOfBlocksLabel)
        ...
        self.settingsForm.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.numberOfBlocksSpinBox)
        self.horizontalLayout_6.addLayout(self.settingsForm)
        ...
        self.outputTextBrowser = QtWidgets.QTextBrowser(self.outputGroupBox)
        self.outputTextBrowser.setObjectName("outputTextBrowser")
        self.horizontalLayout_9.addWidget(self.outputTextBrowser)
        self.settingsLayout.addWidget(self.outputGroupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.requestsHolidaysLabel.setText(_translate("MainWindow", "Requests and Holidays"))
        self.loadRequestsHolidaysButton.setText(_translate("MainWindow", "Load"))
