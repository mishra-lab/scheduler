...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.requestsHolidaysLabel = QtWidgets.QLabel(self.setupGroupBox)
        self.requestsHolidaysLabel.setObjectName("requestsHolidaysLabel")
        self.setupForm.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.requestsHolidaysLabel)
        self.loadRequestsHolidaysButton = QtWidgets.QPushButton(self.setupGroupBox)
        self.loadRequestsHolidaysButton.setObjectName("loadRequestsHolidaysButton")
        self.setupForm.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.loadRequestsHolidaysButton)
        self.calendarYearLabel = QtWidgets.QLabel(self.setupGroupBox)
        self.calendarYearLabel.setObjectName("calendarYearLabel")
        self.setupForm.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.calendarYearLabel)
        ...
        self.setupForm.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.calendarYearSpinBox)
        self.numberOfBlocksLabel = QtWidgets.QLabel(self.setupGroupBox)
        self.numberOfBlocksLabel.setObjectName("numberOfBlocksLabel")
        self.setupForm.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.numberOfBlocksLabel)
        ...
        self.setupForm.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.numberOfBlocksSpinBox)
